                ...
                <div class="joe_detail-wrapper">
                    ...
                    <div class="joe_detail__count">
                        ...
                        <time class="joe_detail__count-created"
                              datetime="${post.createTime?date('yyyy-MM-dd')}">${post.createTime?date('yyyy-MM-dd')}</time>
                    </div>
                    <#import "template/ads/ads_post.ftl" as adpost>
                    <@adpost.ads_post type="top" />
                    <article
                            class="joe_detail__article animated fadeIn center-img ${(settings.enable_code_line_number==true)?then(' line-numbers','')}${settings.enable_single_code_select?then(' single_code_select','')}">
                        <div id="post-inner">
                            ${post.formatContent!}
                        </div>
                    </article>
