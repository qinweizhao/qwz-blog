<ul class="aside_operations">
    ...
    <#if post.status!='DRAFT'>
        ...
        <li class="post-operate-share">
            <a href="http://service.weibo.com/share/share.php?sharesource=weibo&title=分享：${post.title!}，原文链接：${post_url}&pic=${post.thumbnail!}"
        ...
        <li class="post-operate-share">
            <a href="https://connect.qq.com/widget/shareqq/index.html?url=${post_url}&title=${post.title!}&pics=${post.thumbnail!}"
        ...
        <li class="post-operate-share">
            <a href="https://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=${post_url}&sharesource=qzone&title=${post.title!}&pics=${post.thumbnail!}"
