<div class="swiper-slide">
  <a class="item clickable" href="${theme.repo + '/#readme'}" target="_blank" rel="noopener noreferrer nofollow">
    <img width="100%" height="100%" class="thumbnail lazyload" data-src="${BASE_RES_URL+'/source/img/hot_cover1.jpg'}" src="${settings.banner_lazyload_img}" onerror="Joe.errorImg(this)" alt="欢迎使用">
