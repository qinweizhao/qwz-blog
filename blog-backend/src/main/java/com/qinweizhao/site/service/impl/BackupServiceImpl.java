...
public class BackupServiceImpl implements BackupService {
    ...
    public BackupDTO backupWorkDirectory() {
        ...
        try {
            ...
            // Zip halo
            com.qinweizhao.site.utils.FileUtils.zip(Paths.get(this.haloProperties.getWorkDir()), haloZipPath);
    ...
    public void deleteWorkDirBackup(String fileName) {
        ...
        com.qinweizhao.site.utils.FileUtils.checkDirectoryTraversal(backupRootPath, backupPath);
    ...
    public Resource loadFileAsResource(String basePath, String fileName) {
        ...
        try {
            ...
            // Check directory traversal
            com.qinweizhao.site.utils.FileUtils.checkDirectoryTraversal(backupParentPath, backupFilePath);
    ...
    public void deleteExportedData(String fileName) {
        ...
        com.qinweizhao.site.utils.FileUtils.checkDirectoryTraversal(dataExportRootPath, backupPath);
